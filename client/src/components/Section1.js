        ...
        <div className='s1-div1 container d-flex justify-content-center'>
            <div className='row'>
                ...
                </div>
                {
                  ...
                  <h2>Enjoy rides and/or add your vechile now,</h2>
                  <button className='button mt-2'><Link to="/search" className="text-decoration-none text-dark">Explore carpool</Link></button>
                  </div> 
                  : <div className='col'>
                  <h2>Enjoy rides and/or add your vechile now,</h2>
