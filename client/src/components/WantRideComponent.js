...
const WantRideComponent = () => {
      ...
      const handleSubmit = (e) =>{
        ...
        e.preventDefault();
        axios.get("http://localhost:8000/search", { params:
         {
           source:`${data.source}`,
           des:`${data.des}`
          }
  ...
  return (
    ...
    <div className='mt-5 text-center'>
        <div className='mt-5'>
           ...
           <input type="text" className='px-3 py-1 rounded mt-1' name = 'source' onChange={(e)=>handleChange(e)} placeholder='From' />
           <input type="text" className='px-3 py-1 rounded mt-1' name = 'des' onChange={(e)=>handleChange(e)} placeholder='To' />
